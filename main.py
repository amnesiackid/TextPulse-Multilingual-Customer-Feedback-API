...
@app.post("/analyze")
async def analyze(request: models.AnalysisRequest, settings: dict = Depends(get_settings)) -> models.AnalysisResponse:
    text = request.text
    ...
    return models.AnalysisResponse(
        ...
        detected_language=request.language_hint or "en", # TODO week 4: implement actual language detection
